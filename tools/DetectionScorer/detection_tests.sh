...
test_c1_1() {
    ...
    echo_and_run python3 DetectionScorer.py -o "$compcheckfile_outdir/$checkfile_outdir_basename" \
                       -t manipulation \
...
test_c5_1() {
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-1 \
                        -t manipulation \
                        --refDir $testsuite_directory/reference \
                        -r NC2016-manipulation-ref.csv \
                        -x NC2016-manipulation-index.csv \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-2 \
                          -t manipulation \
                          --refDir $testsuite_directory/reference \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-3 \
                          -t manipulation \
                          --refDir $testsuite_directory/reference \
                          -r NC2016-manipulation-ref.csv -x NC2016-manipulation-index.csv \
                          --sysDir $testsuite_directory/baseline \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-4 \
                    -t manipulation \
                    --refDir $testsuite_directory/reference \
                    -r NC2016-manipulation-ref.csv \
                    -x NC2016-manipulation-index.csv \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-5 \
                      -t manipulation \
                      --refDir $testsuite_directory/reference \
                      -r NC2016-manipulation-ref.csv -x NC2016-manipulation-index.csv \
                      --sysDir $testsuite_directory/baseline \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-6 \
                 -t manipulation \
                 --refDir $testsuite_directory/reference \
                 -r NC2016-manipulation-ref.csv -x NC2016-manipulation-index.csv \
                 --sysDir $testsuite_directory/baseline \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-7 \
                 -t manipulation \
                 --refDir $testsuite_directory/reference \
                 -r NC2016-manipulation-ref.csv -x NC2016-manipulation-index.csv \
                 --sysDir $testsuite_directory/baseline \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-8 \
                -t manipulation \
                --refDir $testsuite_directory/reference \
                -r NC2016-manipulation-ref.csv \
                -x NC2016-manipulation-index.csv \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-9 \
                -t manipulation \
                --refDir $testsuite_directory/reference \
                -r NC2016-manipulation-ref.csv \
                -x NC2016-manipulation-index.csv \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-10 \
                -t manipulation \
                --refDir $testsuite_directory/reference \
                -r NC2016-manipulation-ref.csv \
                -x NC2016-manipulation-index.csv \
    ...
    echo "  * Splice Task    *  "
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-11 \
                -t splice \
                --refDir $testsuite_directory/reference \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-12 \
                -t manipulation \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-13 \
                -t manipulation \
                --refDir $testsuite_directory/ \
                -r reference/NC2017-manipulation-ref.csv \
                -x reference/NC2017-manipulation-index.csv \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-14 \
                -t manipulation \
                --refDir $testsuite_directory/ \
                -r reference/NC2017-manipulation-ref.csv \
                -x reference/NC2017-manipulation-index.csv \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-15 \
                -t manipulation \
                --refDir $testsuite_directory/ \
                -r reference/NC2017-manipulation-ref.csv \
                -x reference/NC2017-manipulation-index.csv \
    ...
    echo_and_run python3 DetectionScorer.py -o $compcheckfile_outdir/$checkfile_outdir_basename-16 \
                -t manipulation \
                --refDir $testsuite_directory/ \
                -r reference/NC2017-manipulation-ref.csv \
                -x reference/NC2017-manipulation-index.csv \
