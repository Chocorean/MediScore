...
#        self.assertEqual(myval.fullCheck(True,identify,NCID,neglectMask),0)
        myval = os.system("python3 validator.py -nc --ncid {} -vt SSD -s {} -x {} -p {} {}{}> vmb.log".format(NCID,validatorRoot + 'foo_NC2016_UnitTest_Manipulation_ImgOnly_p-baseline_1/foo_NC2016_UnitTest_Manipulation_ImgOnly_p-baseline_1.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-manipulation-index.csv',procs,identify_string,nm_string))//256 
        self.assertEqual(myval,0)
        os.system('rm vmb.log')

        #no namecheck case
        myval = os.system("python3 validator.py -vt SSD -s {} -x {} -p {} {}{}> vmb1.log".format(validatorRoot + 'foo/foo.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-manipulation-index.csv',procs,identify_string,nm_string))//256
        self.assertEqual(myval,0)
        os.system('rm vmb1.log')

        #no mask
        myval = os.system("python3 validator.py -vt SSD -s {} -x {} -p {} {}{}> vmb2.log".format(validatorRoot + 'nomask/nomask.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-manipulation-index.csv',procs,identify_string,nm_string))//256
        self.assertEqual(myval,0)
...
#        self.assertEqual(errstr.count("Dimensions"),2)
        ...
        myval = os.system("python3 validator.py --ncid {} -vt SSD -s {} -x {} -p {} {}{}> vm6_2.log".format(NCID,validatorRoot + 'baz_NC2016_UnitTest_Manipulation_ImgOnly_p-baseline_1/rewritten_output.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-manipulation-index.csv',procs,identify_string,nm_string))//256 
...
#        errstr = errmsg.read()
    ...
    def testSSDVideoContent(self):
        ...
        myval = os.system("python3 validator.py --ncid {} -vt SSD-video -s {} -x {} -p {} {}{}> vvb.log".format(NCID,
        ...
        myval = os.system("python3 validator.py --ncid {} -vt SSD-video -s {} -x {} -p {} {}{}> vvb2.log".format(NCID,
        ...
        myval = os.system("python3 validator.py --ncid {} -vt SSD-video -s {} -x {} -p {} {}{}> vv0.log".format(NCID,
        ...
        myval = os.system("python3 validator.py --ncid {} -vt SSD-video -s {} -x {} -p {} {}{}> vv1.log".format(NCID,
        ...
        myval = os.system("python3 validator.py --ncid {} -vt SSD-video -s {} -x {} -p {} {}{}> vv2.log".format(NCID,
        ...
        myval = os.system("python3 validator.py --ncid {} -vt SSD-video -s {} -x {} -p {} --ignore_overlap {}{}> vv21.log".format(NCID,
                                                                                                                validatorRoot + 'selfcrossvidtest/selfcrossvidtest.csv',
                                                                                                                validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-manipulation-video-index{}.csv'.format(versfx),
                                                                                                                procs,
                                                                                                                identify_string,
        ...
        myval = os.system("python3 validator.py --ncid {} -vt SSD-video -s {} -x {} -p {} {}{}> vv3.log".format(NCID,
        ...
        myval = os.system("python3 validator.py --ncid {} -vt SSD-video -s {} -x {} --ignore_eof -p {} {}{}> vv4.log".format(NCID,
                                                                                                                validatorRoot + 'oobvidtest/oobvidtest.csv',
                                                                                                                validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-manipulation-video-index{}.csv'.format(versfx),
                                                                                                                procs,
                                                                                                                identify_string,
    ...
    def testEventVerification(self):
        ...
        logname = 'vev.log'
        myval = os.system("python3 validator.py --ncid {} -vt SSD-event -s {} -x {} -p {} {}{}> {}".format('ValTest',
    ...
    def testCamera(self):
        print("BASIC FUNCTIONALITY validation of SSD-event validator beginning...")
        logname = 'vc.log'
        myval = os.system("python3 validator.py --ncid {} -vt SSD-camera -s {} -x {} -p {} {}{}> {}".format('MFC18',
        ...
        logname = 'vc1.log'
        myval = os.system("python3 validator.py --ncid {} -vt SSD-camera -s {} -x {} --output_revised_system revised_cam.csv -p {} {}{}> {}".format('MFC18',
...
#        self.assertEqual(myval,1)
    ...
    def testDSDName(self):
        ...
        myval = os.system("python3 validator.py -nc --ncid {} -vt DSD -s {} -x {} -p {} {}{}> vsb.log".format(NCID,validatorRoot + 'lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1/lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
...
#        self.assertEqual(myval.fullCheck(True,identify,NCID,neglectMask,validatorRoot + 'NC2016_Test0516_dfz/reference/splice/NC2016-splice-ref.csv'),0)
        ...
        myval = os.system("python3 validator.py -vt DSD -s {} -x {} -p {} {}{}> vsb1.log".format(validatorRoot + 'lorem/lorem.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
        self.assertEqual(myval,0)
...
#        myval = DSD_Validator(validatorRoot + 'lorem__NC2016_UnitTest_Spl_ImgOnly_p-baseline_1/lorem__NC2016_UnitTest_Spl_ImgOnly_p-baseline_1.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv')
        myval = os.system("python3 validator.py -nc --ncid {} -vt DSD -s {} -x {} -p {} {}{}> vs1.log".format(NCID,validatorRoot + 'lorem__NC2016_UnitTest_Spl_ImgOnly_p-baseline_1/lorem__NC2016_UnitTest_Spl_ImgOnly_p-baseline_1.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
...
#        myval = DSD_Validator(validatorRoot + 'lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2/lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv')
        myval = os.system("python3 validator.py -nc --ncid {} -vt DSD -s {} -x {} -p {} {}{}> vs4a.log".format(NCID,validatorRoot + 'lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2/lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
...
#        myval = DSD_Validator(validatorRoot + 'loremb_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2/loremb_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv')
        myval = os.system("python3 validator.py -nc --ncid {} -vt DSD -s {} -x {} -p {} {}{}> vs4b.log".format(NCID,validatorRoot + 'loremb_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2/loremb_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
...
#        myval = DSD_Validator(validatorRoot + 'loremb_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2/loremb_NC2016_UnitTest_Splice_ImgOnly_p-baseline_2.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv')
        myval = os.system("python3 validator.py -nc --ncid {} -vt DSD -s {} -x {} -p {} {}{}> vs4c.log".format(NCID,validatorRoot + 'loremc_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1/loremc_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
...
#        self.assertTrue("ERROR: Row" in errstr) #TODO: temporary measure until we get duplicates back
        ...
        myval = os.system("python3 validator.py -nc --ncid {} -vt DSD -s {} -x {} -p {} {}{}> vs4d.log".format(NCID,validatorRoot + 'loremd_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1/loremd_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
...
#        myval = DSD_Validator(validatorRoot + 'ipsum_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1/ipsum_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv')
        myval = os.system("python3 validator.py -nc --ncid {} -vt DSD -s {} -x {} -p {} {}{}> vs6.log".format(NCID,validatorRoot + 'ipsum_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1/ipsum_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
...
#                idx += len("Dimensions")
        ...
        myval = os.system("python3 validator.py --ncid {} -vt DSD -s {} -x {} -p {} {}{}> vs6_2.log".format(NCID,validatorRoot + 'ipsum_NC2016_UnitTest_Splice_ImgOnly_p-baseline_1/revised_splice.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
...
#        myval = DSD_Validator(validatorRoot + 'lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_3/lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_3.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv')
        myval = os.system("python3 validator.py -nc --ncid {} -vt DSD -s {} -x {} -p {} {}{}> vs7.log".format(NCID,validatorRoot + 'lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_3/lorem_NC2016_UnitTest_Splice_ImgOnly_p-baseline_3.csv',validatorRoot + 'NC2016_Test0516_dfz/indexes/NC2016-splice-index.csv',procs,identify_string,nm_string))//256 
